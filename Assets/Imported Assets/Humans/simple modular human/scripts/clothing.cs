...
public class clothing : MonoBehaviour
{
    ...
    public Texture[][] shoeTextures = new Texture[3][];
    public Texture[][] bottomTextures = new Texture[2][];
    public Texture skinColor;
    ...
    void Awake(){
        ...
        shoes = new GameObject[3];
        hairTextures[0] = hair_a_textures;
        hairTextures[1] = hair_b_textures;
        hairTextures[2] = hair_c_textures;
        hairTextures[3] = hair_d_textures;
        hairTextures[4] = hair_e_textures;
        hairStyles[0] = hair_a;
        hairStyles[1] = hair_b;
        hairStyles[2] = hair_c;
        hairStyles[3] = hair_d;
        hairStyles[4] = hair_e;
        Debug.Log("setting tops");
        tops[0] = jacket;
        tops[1] = pullover;
        tops[2] = shirt;
        tops[3] = t_shirt;
        ...
        shoes[2] = shoes3;
        bottoms[1] = trousers;
        bottoms[0] = shortpants;
        topTextures[0] = jacket_textures;
        topTextures[1] = pullover_textures;
        topTextures[2] = shirt_textures;
        topTextures[3] = t_shirt_textures;
        topTextures[4] = tank_top_textures;
        shoeTextures[0] = shoes1_textures;
        shoeTextures[1] = shoes2_textures;
        shoeTextures[2] = shoes3_textures;
        bottomTextures[0] = shortpants_textures;
    ...
    public void GenerateRandomCharacter(TMP_Dropdown a,TMP_Dropdown b,TMP_Dropdown c,TMP_Dropdown d,TMP_Dropdown e, TMP_Dropdown f, TMP_Dropdown g, TMP_Dropdown h, TMP_Dropdown i, TMP_Dropdown j, TMP_Dropdown k, GameObject[] skinButtons, Button maleButton, Button femaleButton){
        ...
        skinButtons[skinColor].SetActive(true);
        this.skinColor = skin_textures[skinColor];
        gender = Random.Range(0, 2);
        k.ClearOptions();
        GameObject[] maleHair = {hair_a, hair_b, hair_e};
        GameObject[] femaleHair = {hair_c, hair_d};
        ...
        Texture[][] maleHairStyles = {hair_a_textures, hair_b_textures, hair_e_textures};
        Texture[][] femaleHairStyles = {hair_c_textures, hair_d_textures};
        if(gender == 0){
            k.AddOptions(maleOptions);
            maleButton.interactable = false;
            int hairIndex = Random.Range(0, maleHair.Length);
            maleHair[hairIndex].SetActive(true);
            k.value = hairIndex+1;
            maleHair[hairIndex].GetComponent<Renderer>().materials[0].mainTexture = maleHairStyles[hairIndex][Random.Range(0, maleHairStyles[hairIndex].Length)];
        }else if(gender == 1){
            k.AddOptions(femaleOptions);
            femaleButton.interactable = false;
            int hairIndex = Random.Range(0, femaleHair.Length);
            femaleHair[hairIndex].SetActive(true);
            k.value = hairIndex+1;
            femaleHair[hairIndex].GetComponent<Renderer>().materials[0].mainTexture = femaleHairStyles[hairIndex][Random.Range(0, femaleHairStyles[hairIndex].Length)];
        }
        Texture[][] topClothingTextures = {jacket_textures, shirt_textures, t_shirt_textures, pullover_textures, tank_top_textures};
        int topChoose = Random.Range(0, 5);
        int topChoice = Random.Range(0, topClothingTextures[topChoose].Length);
                switch(topChoose){
            case 0: 
            jacket.SetActive(true);
            jacket.GetComponent<Renderer>().materials[0].mainTexture = jacket_textures[topChoice];
            a.value = topChoice+1;
            break;
            case 1:
            shirt.SetActive(true);
            shirt.GetComponent<Renderer>().materials[0].mainTexture = shirt_textures[topChoice];
            b.value = topChoice+1;
            break;
            case 2:
            t_shirt.SetActive(true);
            t_shirt.GetComponent<Renderer>().materials[0].mainTexture = t_shirt_textures[topChoice];
            c.value = topChoice+1;
            break;
            case 3:
            pullover.SetActive(true);
            pullover.GetComponent<Renderer>().materials[0].mainTexture = pullover_textures[topChoice];
            d.value = topChoice+1;
            break;
            case 4:
            tank_top.SetActive(true);
            tank_top.GetComponent<Renderer>().materials[0].mainTexture = tank_top_textures[topChoice];
            e.value = topChoice+1;
            break;
        }
        Texture[][] botClothingTextures = {shortpants_textures, trousers_textures};
        topChoose = Random.Range(0, 2);
        topChoice = Random.Range(0, botClothingTextures[topChoose].Length);
        switch(topChoose){
            case 0: 
            shortpants.SetActive(true);
            shortpants.GetComponent<Renderer>().materials[0].mainTexture = shortpants_textures[topChoice];
            f.value = topChoice+1;
            break;
            case 1:
            trousers.SetActive(true);
            trousers.GetComponent<Renderer>().materials[0].mainTexture = trousers_textures[topChoice];
            g.value = topChoice+1;
            break;
        }
        Texture[][] shoeClothingTextures = {shoes1_textures, shoes2_textures, shoes3_textures};
        topChoose = Random.Range(0, 3);
        topChoice = Random.Range(0, shoeClothingTextures[topChoose].Length);
        switch(topChoose){
            case 0: 
            shoes1.SetActive(true);
            shoes1.GetComponent<Renderer>().materials[0].mainTexture = shoes1_textures[topChoice];
            h.value = topChoice+1;
            break;
            case 1:
            shoes2.SetActive(true);
            shoes2.GetComponent<Renderer>().materials[0].mainTexture = shoes2_textures[topChoice];
            i.value = topChoice+1;
            break;
            case 2:
